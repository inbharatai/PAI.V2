...
| The 180s gap | **TTS model cold start**: the describe run was the first TTS call in the relaunched process; the engine spends ~3 min loading before the 9s actual synthesis. Every subsequent call is fast |
